...
if [ $CXTisCN != "Yes" ];then
    ...
    #wget -O
    wget --no-check-certificate -qO ~/Core_Install.sh 'https://ghproxy.com/https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v5.3.sh' && chmod a+x ~/Core_Install.sh
    CentOSMirrors=""
    CentOSVaultMirrors=""
    DebianMirrors=""
    UbuntuMirrors=""
